...
async def example_usage():
    async with app.run() as router_app:
        ...
        # results = await openai_router.route_to_function(
        ...
        # results = await openai_router.route_to_server(
        ...
        results = await openai_router.route(
